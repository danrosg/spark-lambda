...
object StreamingJob {
    ...
    def main(args:Array[String]) :Unit ={
      ...
      def streamingApp(sc: SparkContext,batchDuration: Duration) = {
        ...
        val inputhPath =isIDE match {
          case true =>  "file:///Users/danielrosales/Code/spark-kafka-cassandra-applying-lambda-architecture/vagrant/input"
          case false =>   "file:///vagrant/input"
        }


        val textDStream =ssc.textFileStream(inputhPath)
